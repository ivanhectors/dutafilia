...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="feedback.php">Feedback .</style></a> | Call us : +62 823 86943219</span>
			</div>
	  ...
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			<li class="active grid"><a class="color1" href="index.php">Home</a></li>
				...
				<li><form class="example pull-right" style="margin:auto;max-width:300px">
  <input type="text" style="margin-bottom: 0px;" id="search_text" placeholder="Search.." name="search_text"></input>
  <button><span href="#" class="fa fa-search"></span></button>
</form></li>
                <li>
			...
			<div class="footer-top">
				<div class="col-md-2 footer-left">
					...
					<ul>
						...
						<li><a target="_blank" href="administrator/loginform.php">Admin Page</a></li>		 
					</ul>
				</div>
